...
from styles.theme import SENTIMENT_COLORS, PLOTLY_LAYOUT, CONTINUOUS_SCALE, SAGE
...
def sentiment_donut(sentiment: dict):
    ...
    fig.update_traces(marker_line_color="#FFFFFF", marker_line_width=2, textfont_family="IBM Plex Mono")
    st.plotly_chart(fig, use_container_width=True)
